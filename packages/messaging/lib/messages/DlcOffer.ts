...
export abstract class DlcOffer {
  public static deserialize(buf: Buffer): DlcOfferV0 | DlcOfferOldV0 {
...
export abstract class DlcOfferOld {
  ...
  public abstract toJSON(): IDlcOfferOldV0JSON;
 ...
 */
export class DlcOfferOldV0 extends DlcOfferOld implements IDlcMessage {
  public static type = MessageType.DlcOfferV0;
