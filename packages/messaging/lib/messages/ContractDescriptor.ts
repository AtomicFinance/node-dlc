...
export abstract class ContractDescriptor {
  public static deserialize(buf: Buffer): ContractDescriptorV0 | ContractDescriptorV1 {
 ...
 */
export class ContractDescriptorV0 extends ContractDescriptor implements IDlcMessage {
 ...
 * and their corresponding payouts.
 */
export class ContractDescriptorV1 extends ContractDescriptor implements IDlcMessage {
