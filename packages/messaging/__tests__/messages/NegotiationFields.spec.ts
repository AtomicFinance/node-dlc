...
import { NegotiationFields, NegotiationFieldsV0, NegotiationFieldsV1, NegotiationFieldsV2 } from "../../lib/messages/NegotiationFields";
    ...
    describe("deserialize", () => {
      it("deserializes", () => {
        ...
        if (unknownInstance.type === MessageType.NegotiationFieldsV1) {
          ...
          expect(instance.roundingIntervals.serialize().toString('hex')).to.equal(
            "fda724" + // type rounding_intervals_v0
            "08" + // length
            "0001" + // num_rounding_intervals
            "fd1388" + // begin_interval
    ...
    describe("deserialize", () => {
      it("deserializes", () => {
        ...
        if (unknownInstance.type === MessageType.NegotiationFieldsV2) {
          ...
          expect(instance.negotiationFieldsList[0].serialize().toString('hex')).to.equal(
            "fdd828" + // type negotiation_fields_v1
            "0c" + // length
            "fda724" + // type rounding_intervals_v0
            "08" + // length
          ...
          expect(instance.negotiationFieldsList[1].serialize().toString('hex')).to.equal(
            "fdd826" + // type negotiation_fields_v0
            "00" // length
          )
        }
