...
import { OracleAttestationV0Pre163 } from '../../../lib/messages/pre-163/OracleAttestation';

describe('OracleAttestationV0Pre163', () => {
  ...
  describe('deserialize', () => {
    it('deserializes', () => {
      ...
      const instance = OracleAttestationV0Pre163.deserialize(buf);
