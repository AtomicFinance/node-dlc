...
export class RoutesV0 {
  ...
  constructor(
    ...
    app.get(
      this.getEndpoint(Endpoint.OrderOffer, ':temporderid'),
      basicAuth(options),
    ...
    app.get(
      this.getEndpoint(Endpoint.OrderAccept, ':temporderid'),
      basicAuth(options),
    ...
    app.get(
      this.getEndpoint(Endpoint.DlcOffer, ':tempcontractid'),
      basicAuth(options),
    ...
    app.get(
      this.getEndpoint(Endpoint.DlcAccept, ':contractid'),
      basicAuth(options),
    ...
    app.get(
      this.getEndpoint(Endpoint.DlcSign, ':contractid'),
      basicAuth(options),
