...
describe('Chain Monitoring', () => {
  ...
  describe(`POST ${apiPrefix}/${Endpoint.DlcOffer}/decode`, () => {
    it('should decode dlc offer', (done) => {
      chai
        .request(server.app)
    ...
    describe('DlcOffer', () => {
      describe(`GET ${apiV0Prefix}/${Endpoint.DlcOffer}`, () => {
        it('should return 200 and dlcoffer if dlc offer exists', (done) => {
          chai
            .request(server.app)
            .get(`/${apiV0Prefix}/${Endpoint.DlcOffer}/${dlcTempContractId}`)
            .auth('admin', util.apikey)
        ...
        it('should return 404 if dlc offer does not exist', (done) => {
          ...
          chai
            ...
            .get(
              `/${apiV0Prefix}/${
                Endpoint.DlcOffer
              }/${invalidTempContractId.toString('hex')}`,
            )
            .auth('admin', util.apikey)
            .end((err: HttpException, res: request.Response) => {
              expect(err).to.be.null;
      ...
      describe(`GET ${apiV0Prefix}/${Endpoint.DlcSign}`, () => {
        ...
        it('should return 404 if dlc sign does not exist', (done) => {
          ...
          chai
            .request(server.app)
            .get(
              `/${apiV0Prefix}/${Endpoint.DlcSign}/${invalidContractId.toString(
                'hex',
              )}`,
            )
            .auth('admin', util.apikey)
  ...
  describe(`DlcAccept and DlcFinalize`, () => {
    ...
    describe('DlcAccept', () => {
      describe(`GET ${apiV0Prefix}/${Endpoint.DlcAccept}`, () => {
        it('should get dlc accept by contract id', (done) => {
          chai
            .request(server.app)
            .get(
              `/${apiV0Prefix}/${Endpoint.DlcAccept}/${contractId.toString(
                'hex',
              )}`,
            )
            .auth('admin', util.apikey)
      ...
      describe(`POST ${apiV0Prefix}/${Endpoint.DlcAccept}`, () => {
        ...
        it('should return 400 if dlc offer invalid', (done) => {
          chai
            .request(server.app)
            .post(`/${apiV0Prefix}/${Endpoint.DlcAccept}`)
            .auth('admin', util.apikey)
