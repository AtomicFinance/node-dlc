...
const tests = [
  ...
  [
    '.readBigUInt64LE()',
    () => sut(8).readBigUInt64LE(),
    BigInt('578437695752307201'),
  ],
  ['.readBigUInt64LE() RangError', () => sut(1).readBigUInt64LE(), RangeError],
  [
    '.readBigUInt64BE()',
    () => sut(8).readBigUInt64BE(),
    BigInt('72623859790382856'),
  ],
  ['.readBigUInt64BE() RangError', () => sut(1).readBigUInt64BE(), RangeError],

  ['.readVarInt() 1 byte', () => sut('01').readVarInt(), BigInt(1)],
  [
    '.readVarInt() 2 byte number',
    () => sut('fd0001').readVarInt(),
    BigInt(256),
  ],
  [
    '.readVarInt() 4 byte number',
    () => sut('fe00000001').readVarInt(),
    BigInt(16777216),
  ],
  [
  ...
  [
    '.readBigSize() 2 byte number',
    () => sut('fd0100').readBigSize(),
    BigInt(256),
  ],
  [
    '.readBigSize() 4 byte number',
    () => sut('fe01000000').readBigSize(),
    BigInt(16777216),
  ],
  [
